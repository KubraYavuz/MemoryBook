package com.example.user.memorybook.user_sign;
...
import com.example.user.memorybook.MainActivity;
import com.example.user.memorybook.R;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void logIn(String email, String passwoord){
        final ProgressDialog progressDialog=new ProgressDialog(this);
        progressDialog.setMessage("Giriş yapılıyor, lütfen bekleyiniz...");
        progressDialog.show();

        fAuth.signInWithEmailAndPassword(email,passwoord)
